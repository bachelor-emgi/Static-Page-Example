...
document.addEventListener("DOMContentLoaded", function() {
  const openMenuButton = document.querySelector("[data-wp-on-async--click='actions.openMenuOnClick']");
  const closeMenuButton = document.querySelector("[data-wp-on-async--click='actions.closeMenuOnClick']");
  ...
  if (openMenuButton) {
      openMenuButton.addEventListener("click", openMenuOnClick);
  }

  if (closeMenuButton) {
      closeMenuButton.addEventListener("click", closeMenuOnClick);
  }
});
